...
Function InitItemTemplates()
	...
	CreateItemTemplate("Radio Transceiver", "radio", "GFX\items\radio.x", "GFX\items\INVradio.jpg", "GFX\items\radio.png", 0.0010);1.0)
	CreateItemTemplate("Radio Transceiver", "fineradio", "GFX\items\radio.x", "GFX\items\INVradio.jpg", "GFX\items\radio.png", 0.0010);1.0)
	CreateItemTemplate("Radio Transceiver", "veryfineradio", "GFX\items\radio.x", "GFX\items\INVradio.jpg", "GFX\items\radio.png", 0.0010);1.0)
	CreateItemTemplate("Radio Transceiver", "18vradio", "GFX\items\radio.x", "GFX\items\INVradio.jpg", "GFX\items\radio.png", 0.0012);1.02)
	...
	it = CreateItemTemplate("SCP-178", "scp178", "GFX\items\scp178.b3d", "GFX\items\INV178.jpg", "", 0.024,"","","",1)
	it = CreateItemTemplate("Note from Maynard", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\maynard005note.png", 0.0025) : it\sound = 0
			...
			If Inventory(n) = Null Then
				Select item\itemtemplate\tempname
					...
					Case "killbat"
						...
						Kill()
					Case "scp178"
						;SetAnimTime ClosestItem\obj,19.0	
					Case "scp148"
					...
					Case "firstaid", "finefirstaid", "veryfinefirstaid", "firstaid2"
						item\state = 0
					Case "navigator", "nav"
						If item\itemtemplate\name = "S-NAV Navigator Ultimate" Then AchvSNAV = True;GiveAchievement(AchvSNAV)
					Case "hazmatsuit", "hazmatsuit2", "hazmatsuit3"
						canpickitem = True
