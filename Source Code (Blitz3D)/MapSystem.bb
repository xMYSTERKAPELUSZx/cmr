...
Function CreateMap()
	...
	SetRoom("roompj", ROOM1, Floor(0.1*Float(Room1Amount)),min_pos,max_pos)
	SetRoom("914", ROOM1, Floor(0.3*Float(Room1Amount)),min_pos,max_pos)
	...
	SetRoom("room2testroom2", ROOM2, Floor(0.1*Float(Room2Amount)),min_pos,max_pos)
	SetRoom("room2scps", ROOM2, Floor(0.2*Float(Room2Amount)),min_pos,max_pos)
	...
	SetRoom("room012", ROOM2, Floor(0.55*Float(Room2Amount)),min_pos,max_pos)
    ...
    SetRoom("room106", ROOM1, Room1Amount[0]+Floor(0.3*Float(Room1Amount)),min_pos,max_pos)
    ...
    SetRoom("coffin", ROOM1, Room1Amount[0]+Floor(0.7*Float(Room1Amount)),min_pos,max_pos)
	...
	SetRoom("testroom", ROOM2, Room2Amount[0]+Floor(0.7*Float(Room2Amount)),min_pos,max_pos)
	...
	SetRoom("room2sroom", ROOM2, min_pos+Floor(0.3*Float(Room2Amount)),min_pos,max_pos)
	...
	SetRoom("room2offices2", ROOM2, min_pos+Floor(0.9*Float(Room2Amount)),min_pos,max_pos)
